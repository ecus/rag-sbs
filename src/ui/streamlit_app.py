...
with tab_grafo:
    ...
    # Detectar el host con el que el navegador llegó a Streamlit, para que el
    # iframe del grafo use la MISMA IP/host (no `localhost`, que apunta a la
    # máquina del cliente cuando se accede en red local).
    try:
